...
export const DEFAULT_STORIES: StoryData[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "รุ่นที่ 3 · ผู้ให้รสมือ: 'ตาเงิน กับ ยายจัน' — ตาทำกับข้าว ยายจัดใส่ปิ่นโต ผูกหน้ารถป๊อปน้อยคู่ใจ ขี่ไปส่งลูกหลานกินทีละบ้าน กับข้าวเดินทางก่อนคำว่าเดลิเวอรีจะเกิดหลายสิบปี พริกแกงตาเงินยายจันทำเองตามสูตรของครอบครัวจนกลายเป็นรสมือเฉพาะตระกูล",
  ...
  },
  {
    ...
    photos: [
      {
        ...
        caption: "หมูทอดลับแลพริกข่า จานซิกเนเจอร์อันดับหนึ่ง คลุกเคล้าพริกข่าสูตรทำเองของบ้าน",
        tag: "จานเด็ดซิกเนเจอร์",
      },
      {
        url: "/images/menu/nam_prik_noom.jpg",
        caption: "น้ำพริกหนุ่มจากพริกหนุ่มเผาเตาถ่าน ปรุงสดคู่กระเทียมไทย เสิร์ฟพร้อมแคบหมูและผักลวก",
        tag: "ทำสดทุกวัน",
      },
      {
      ...
      },
      {
        ...
        caption: "สำรับขันโตกชุดใหญ่ รวมเมนูจากพริกแกงทำเองของบ้านสำหรับรับประทานร่วมวง",
        tag: "สำรับขันโตก",
      },
      {
    ...
    highlights: [
      { title: "พริกแกงทำเองโดยป้า ๆ", desc: "คัดและเตรียมสมุนไพรตามสูตรของครอบครัว เพื่อรสชาติที่เป็นเอกลักษณ์" },
