...
const DEFAULT_STORIES: StoryData[] = [
  {
    ...
    quote: "“นี่ไม่ใช่แค่ร้านอาหาร แต่คือบ้านจริงๆ ของครอบครัวเราที่ผ่านแดดฝนมาเกินหนึ่งศตวรรษ”",
    ...
    photos: [
      {
        ...
        caption: "ป้ายไม้แกะสลัก 'เรือนหม่อนน้อย' โคมล้านนาหลากสี และหน้าต่างไม้สักโบราณ",
        tag: "ตัวเรือนจริง",
      },
      {
        url: "/uploads/1788435835557_pn69j3.jpg",
        caption: "ใต้ถุนเรือนไม้ เสาไม้สักโบราณ โต๊ะไม้สักแท้ และโคมแขวนใต้ถุนที่เปิดรับลมตลอดวัน",
        tag: "ใต้ถุนเรือน",
      },
      {
    ...
    highlights: [
      { title: "ไม้สักทองโบราณทั้งหลัง", desc: "คัดไม้สักแก่ลายทอง ปลวกมอดไม่กิน ทนทานนานนับศตวรรษ" },
  ...
  },
  {
    ...
    photos: [
      {
        url: "/uploads/1788435835557_pn69j3.jpg",
        caption: "เสาไม้สักต้นใหญ่และโครงสร้างขื่อคานใต้ถุน ที่เชื่อมต่อด้วยการเข้าเดือยไร้ตะปู",
        tag: "เสาและขื่อคาน",
      },
      {
        url: "/uploads/1780565008509_ldvq14.JPG",
  ...
  },
  {
    ...
    title: "ตำมือ ๑๐๐% – กลิ่นพริกแกงสด และป้าๆ ในครัวลับแล",
    ...
    highlights: [
      ...
      { title: "รสมือป้าๆ ในครอบครัว", desc: "ปรุงด้วยความใส่ใจและสูตรดั้งเดิม ไม่ใช้ผงชูรสปรุงแต่ง" },
    ],
  },
];
