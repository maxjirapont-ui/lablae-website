...
export const DEFAULT_ABOUT_DATA: AboutCustomData = {
  ...
  tab1_gen3_desc: "ตาทำกับข้าว ยายจัดใส่ปิ่นโต ห้อยไว้กับรถป๊อปน้อยคู่ใจ ขี่ไปส่งลูกหลานทีละบ้าน กับข้าวเดินทางก่อนคำว่า “เดลิเวอรี” จะเกิดหลายสิบปี พริกแกงทำเองตามสูตรของครอบครัว ไม่มีของสำเร็จเข้าบ้านนี้ และคือต้นกำเนิดของสำรับบ้านเรา: แกงอ่อม, สามชั้นทอดพริกข่า, น้ำพริกหนุ่ม, น้ำพริกอ่อง, และไส้อั่ว",
  ...
  tab2_intro: "หลายคนแปลกใจเมื่อได้ทานอาหารลับแล เพราะถึงแม้จะใช้คำเมือง ทานข้าวเหนียว แต่รสชาติกลับกลมกล่อม หวานละมุน และถูกปากคนภาคกลางอย่างน่าประหลาด คำตอบของเรื่องนี้ ยายจันเคยตอบไว้ในประโยคเดียวระหว่างเตรียมพริกแกง:",
