        ...
        <div className="space-y-8 font-thai text-sm sm:text-base leading-relaxed text-[#f5ece1]/85">
          ...
          <div className="space-y-6 relative border-l-2 border-accent/40 pl-6 ml-2 sm:ml-4">
            ...
            <div className="relative space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#f5ece1]/80">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6 font-thai text-sm sm:text-base leading-relaxed text-[#f5ece1]/85">
          ...
          <blockquote className="p-5 bg-[#1f140e] border-l-4 border-accent rounded-r-2xl text-base sm:text-lg font-bold text-primary italic">
          ...
          <div className="p-5 bg-[#1f140e] rounded-2xl border border-accent/20">
      ...
      content: (
        <div className="space-y-6 font-thai text-sm sm:text-base leading-relaxed text-[#f5ece1]/85">
          <div className="p-5 bg-[#1f140e] border-l-4 border-accent rounded-r-2xl space-y-2">
            ...
            <p className="text-xs sm:text-sm text-[#f5ece1]/80 italic pt-1">
    ...
    <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8 space-y-12">
      ...
      <div id="directions" className="scroll-mt-24 p-8 sm:p-10 wood-card bg-[#241710] rounded-3xl border border-accent/20 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2 font-thai">
          <div className="p-5 bg-[#1a100a] rounded-2xl border border-accent/20 space-y-2">
          ...
          <div className="p-5 bg-[#1a100a] rounded-2xl border border-accent/20 space-y-2">
            ...
            <p className="text-xs sm:text-sm text-[#f5ece1]/80 leading-relaxed">
              โทร: <a href="tel:0956283125" className="font-bold text-accent underline">095-628-3125</a>
            </p>
          </div>
        </div>
        ...
        <div className="pt-2 flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-accent hover:brightness-110 text-[#1a100a] rounded-full font-thai text-sm font-bold shadow-md transition-all hover:scale-105"
          >
            <MapPin className="w-4 h-4" />
          ...
          <Link
            href="/menu"
            className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[#2a1a12] hover:bg-[#342117] text-[#f5ece1] border border-accent/30 rounded-full font-thai text-sm font-semibold transition-all hover:scale-105"
          >
